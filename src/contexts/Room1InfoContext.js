...
export const Room1ContextProvider = function ({ children }) {
  ...
  const [room1Quantity, onChangeRoom1Quantity, onResetRoom1Quantity] = useInput(
  ...
  const [room1Sleeps, onChangeRoom1Sleeps, onResetRoom1Sleeps] = useInput(2);
  ...
  return (
    <room1Context.Provider
      value={{
        ...
        room1Quantity: [
          room1Quantity,
          onChangeRoom1Quantity,
          onResetRoom1Quantity,
        ],
